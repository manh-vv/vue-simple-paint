...
const broomSvg = new Image();
broomSvg.setAttribute('type', 'image/svg+xml');
broomSvg.src = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
...
`;
broomSvg.onload = () => {
  console.log('typeof svg:', typeof broomSvg);
};
...
export class Broom extends Pen {
  ...
  startDraw(mouse) {
    console.log('-t', typeof broomSvg, broomSvg);
    this.ctx.drawImage(broomSvg, mouse.x, mouse.y);
  }
